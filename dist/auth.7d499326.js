...
signupForm.addEventListener('submit', e => {
  ...
  const password = signupForm['signup-password'].value; //sign up the user
...
loginForm.addEventListener('submit', e => {
  ...
  auth.signInWithEmailAndPassword(email, password).then(cred => {
    console.log(cred.user); //close and reset
...
},{}]},{},["../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","JS/auth.js"], null)
//# sourceMappingURL=/auth.7d499326.js.map